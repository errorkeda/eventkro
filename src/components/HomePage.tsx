...
export default function HomePage() {
  ...
  return (
    <main>
      ...
      <section className="relative h-[80vh] overflow-hidden" aria-label="Event planning services">
        {/* Slides */}
        ...
        <div className="container mx-auto px-4 relative z-20 h-full flex items-center pointer-events-none">
          <div className="text-center text-white max-w-4xl mx-auto pointer-events-auto">
            ...
            <p className="text-lg sm:text-xl md:text-2xl mb-8 animate-fade-in-delay text-white/95">
              {heroSubheadline}
            </p>
            <Link
              href={heroSlides[currentSlide].href}
              className="btn-primary text-lg animate-fade-in-delay-2"
            >
